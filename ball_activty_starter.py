...
x_location2 = int(SCREEN_WIDTH/10)
y_location2 = int(SCREEN_HEIGHT/10)
...
while not done:
    ...
    pygame.draw.circle(screen, ball_color2, [x_location2, y_location2], ball_size)
    # pygame.draw.circle2(screen, ball_color2, [x_location, y_location], ball_size)
